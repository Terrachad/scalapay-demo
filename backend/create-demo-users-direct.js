      ...
      try {
        ...
        if (existing.length > 0) {
          ...
          await connection.execute(
            ...
            [user.password, user.name, user.role, user.creditLimit, user.availableCredit, user.email]
          );
          ...
          await connection.execute(
            ...
            [userId, user.email, user.password, user.name, user.role, 1, user.creditLimit, user.availableCredit]
          );
