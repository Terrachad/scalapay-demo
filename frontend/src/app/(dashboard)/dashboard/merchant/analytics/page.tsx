...
export default function MerchantAnalyticsPage() {
  ...
  const totalRevenue =
    ...
    (transactions ? transactions.reduce((sum, t) => sum + parseFloat(t.amount.toString()), 0) : 0);
  ...
  const avgOrderValue =
    ...
    (transactions && transactions.length > 0 ? totalRevenue / transactions.length : 0);
                              ...
                              <div className="text-right">
                                ...
                                <div className="w-20 h-2 bg-gray-200 rounded-full">
                                  <div
                                    ...
                                    style={{
                                      width: `${Math.min((day.revenue / Math.max(...dailyRevenue.map((d) => d.revenue))) * 100, 100)}%`,
                                    }}
                                  ></div>
                                </div>
                              </div>
                            ...
                            <div className="text-right">
                              ...
                              <div className="w-24 h-2 bg-gray-200 rounded-full">
                                <div
                                  ...
                                  style={{
                                    width: `${(count / Math.max(...Object.values(paymentPlanStats))) * 100}%`,
                                  }}
                                ></div>
                              </div>
                            </div>
